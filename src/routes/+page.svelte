...
<div class="quiz-container">
  ...
  <div class="section">
    ...
    <div class="button-group">
      <button on:click={() => { ilevel = 1; console.log('level 1 clicked'); }} 
              style="background-color: {ilevel === 1 ? '#4CAF50' : 'darkblue'};">
        1
      </button>
      <button on:click={() => { ilevel = 2; console.log('level 2 clicked'); }} 
              style="background-color: {ilevel === 2 ? '#4CAF50' : 'darkblue'};">
        2
      </button>
      <button on:click={() => { ilevel = 3; console.log('level 3 clicked'); }} 
              style="background-color: {ilevel === 3 ? '#4CAF50' : 'darkblue'};">
        3
      </button>
      <button on:click={() => { ilevel = 4; console.log('level 4 clicked'); }} 
              style="background-color: {ilevel === 4 ? '#4CAF50' : 'darkblue'};">
        4
      </button>
      <button on:click={() => { ilevel = 5; console.log('level 5 clicked'); }} 
              style="background-color: {ilevel === 5 ? '#4CAF50' : 'darkblue'};">
        5
      </button>
      <button on:click={() => { ilevel = 6; console.log('level 6 clicked'); }} 
              style="background-color: {ilevel === 6 ? '#4CAF50' : 'darkblue'};">
        6
      </button>
      <button on:click={() => { ilevel = 7; console.log('level 7 clicked'); }} 
              style="background-color: {ilevel === 7 ? '#4CAF50' : 'darkblue'};">
        7
      </button>
      <button on:click={() => { ilevel = 8; console.log('level 8 clicked'); }} 
              style="background-color: {ilevel === 8 ? '#4CAF50' : 'darkblue'};">
        8
      </button>
      <button on:click={() => { ilevel = 9; console.log('level 9 clicked'); }} 
              style="background-color: {ilevel === 9 ? '#4CAF50' : 'darkblue'};">
        9
      </button>
      <button on:click={() => { ilevel = 10; console.log('level 10 clicked'); }} 
              style="background-color: {ilevel === 10 ? '#4CAF50' : 'darkblue'};">
        10
      </button>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <div class="button-group">
      <button style="background-color: {correctAnswersCount === 0 ? '#4CAF50' : 'darkblue'};" disabled>0</button>
      <button on:click={() => { iqa = 1; console.log('question 1 clicked'); }} 
              style="background-color: {correctAnswersCount >= 1 ? '#4CAF50' : 'darkblue'};">
        1
      </button>
      <button on:click={() => { iqa = 2; console.log('question 2 clicked'); }} 
              style="background-color: {correctAnswersCount >= 2 ? '#4CAF50' : 'darkblue'};">
        2
      </button>
      <button on:click={() => { iqa = 3; console.log('question 3 clicked'); }} 
              style="background-color: {correctAnswersCount >= 3 ? '#4CAF50' : 'darkblue'};">
        3
      </button>
      <button on:click={() => { iqa = 4; console.log('question 4 clicked'); }} 
              style="background-color: {correctAnswersCount >= 4 ? '#4CAF50' : 'darkblue'};">
        4
      </button>
      <button on:click={() => { iqa = 5; console.log('question 5 clicked'); }} 
              style="background-color: {correctAnswersCount >= 5 ? '#4CAF50' : 'darkblue'};">
        5
      </button>
      <button on:click={() => { iqa = 6; console.log('question 6 clicked'); }} 
              style="background-color: {correctAnswersCount >= 6 ? '#4CAF50' : 'darkblue'};">
        6
      </button>
      <button on:click={() => { iqa = 7; console.log('question 7 clicked'); }} 
              style="background-color: {correctAnswersCount >= 7 ? '#4CAF50' : 'darkblue'};">
        7
      </button>
      <button on:click={() => { iqa = 8; console.log('question 8 clicked'); }} 
              style="background-color: {correctAnswersCount >= 8 ? '#4CAF50' : 'darkblue'};">
        8
      </button>
      <button on:click={() => { iqa = 9; console.log('question 9 clicked'); }} 
              style="background-color: {correctAnswersCount >= 9 ? '#4CAF50' : 'darkblue'};">
        9
      </button>
      <button on:click={() => { iqa = 10; console.log('question 10 clicked'); }} 
              style="background-color: {correctAnswersCount >= 10 ? '#4CAF50' : 'darkblue'};">
        10
      </button>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <div class="answer-options">
      <button on:click={() => checkAnswer(currentOptions[0])} 
              style="background-color: {correctAnswerHighlighted && currentOptions[0] === currentAnswer ? '#4CAF50' : 'darkblue'};">
        {currentOptions[0] || 'Answer A'}
      </button>
      <button on:click={() => checkAnswer(currentOptions[1])} 
              style="background-color: {correctAnswerHighlighted && currentOptions[1] === currentAnswer ? '#4CAF50' : 'darkblue'};">
        {currentOptions[1] || 'Answer B'}
      </button>
      <button on:click={() => checkAnswer(currentOptions[2])} 
              style="background-color: {correctAnswerHighlighted && currentOptions[2] === currentAnswer ? '#4CAF50' : 'darkblue'};">
        {currentOptions[2] || 'Answer C'}
      </button>
      <button on:click={() => checkAnswer(currentOptions[3])} 
              style="background-color: {correctAnswerHighlighted && currentOptions[3] === currentAnswer ? '#4CAF50' : 'darkblue'};">
